...
_ts_decorate([
    (0, _typeorm.ManyToOne)(()=>_userentity.default, (user)=>user.roles, {
        onDelete: 'CASCADE'
    }),
...
_ts_decorate([
    (0, _typeorm.ManyToOne)(()=>_roleentity.default, (role)=>role.users, {
        onDelete: 'CASCADE'
    }),
    (0, _typeorm.JoinColumn)({
        name: 'role_id'
...
_ts_decorate([
    ...
    _ts_metadata("design:type", typeof Date === "undefined" ? Object : Date)
], UserRole.prototype, "deleted_at", void 0);
UserRole = _ts_decorate([
    (0, _typeorm.Entity)('user_roles'),
    (0, _typeorm.Unique)('UQ_user_roles', [
        'user',
        'role'
    ])
], UserRole);
