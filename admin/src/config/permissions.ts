...
export const permissions = {
  doctorDashboard: PERMISSIONS.DASHBOARD_DOCTOR,
  doctorSchedules: PERMISSIONS.DOCTOR_SCHEDULE_MANAGE,
  doctorAppointments: PERMISSIONS.APPOINTMENT_MANAGE,
  tags: PERMISSIONS.TAG_MANAGE,
  articles: PERMISSIONS.ARTICLE_MANAGE,
  topics: PERMISSIONS.TOPIC_MANAGE,
  doctorMessages: PERMISSIONS.MESSAGE_MANAGE,
  patientRecords: PERMISSIONS.PATIENT_RECORD_MANAGE,
  patients: PERMISSIONS.PATIENT_MANAGE,
  doctorSettings: PERMISSIONS.SETTING_UPDATE,
  adminDashboard: PERMISSIONS.DASHBOARD_ADMIN,
  users: PERMISSIONS.USER_MANAGE,
  adminPatients: PERMISSIONS.PATIENT_MANAGE,
  doctors: PERMISSIONS.DOCTOR_MANAGE,
  appointments: PERMISSIONS.APPOINTMENT_MANAGE,
  rolePermissions: PERMISSIONS.ROLE_PERMISSION_MANAGE,
  ratings: PERMISSIONS.SATISFACTION_RATING_MANAGE,
  examResults: PERMISSIONS.EXAMINATION_RESULT_MANAGE,
  relatives: PERMISSIONS.RELATIVE_MANAGE,
  auditLogs: PERMISSIONS.AUDIT_LOG_MANAGE,
  healthProfiles: PERMISSIONS.HEALTH_PROFILE_MANAGE,
  relationships: PERMISSIONS.RELATIONSHIP_MANAGE,
  ...
  notificationSend: PERMISSIONS.NOTIFICATION_SEND,
