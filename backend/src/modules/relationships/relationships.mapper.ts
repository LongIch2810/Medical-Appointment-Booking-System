...
export class RelationshipsMapper {
    static toRelationshipResponseDto(relationship: Relationship): RelationshipResponseDto {
        return plainToInstance(RelationshipResponseDto, relationship, {
            excludeExtraneousValues: true,
        })
    }

    static toRelationshipResponseDtoList(relationships: Relationship[]): RelationshipResponseDto[] {
