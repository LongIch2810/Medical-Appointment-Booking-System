...
/**
 * Standard Loading Component for Admin Portal
...
export function LoadingState({
  ...
  const content = (
    ...
    >
      ...
      >
        ...
        >
          ...
          <path
            ...
            className={cn(
              "fill-none stroke-primary-foreground",
      ...
      <p className="mt-4 text-sm font-semibold text-foreground tracking-tight">
        {label}
      </p>
  ...
  return (
    <Card className="rounded-2xl border border-slate-200/80 bg-white/80 backdrop-blur-xs shadow-xs dark:border-slate-800/80 dark:bg-slate-900/80">
