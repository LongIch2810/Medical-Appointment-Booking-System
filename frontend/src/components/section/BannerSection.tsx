  ...
  return (
    <FadeInView>
      <section className="relative w-full min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:min-h-[750px] xl:min-h-[850px] overflow-hidden rounded-md">
        ...
        {/* Nội dung */}
        <div className="relative z-10 flex flex-col justify-center items-center text-center text-white min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:min-h-[750px] xl:min-h-[850px] px-6 py-10">
          {/* Tiêu đề */}
          <motion.h1
