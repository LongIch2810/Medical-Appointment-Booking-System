...
_ts_decorate([
    ...
    _ts_metadata("design:type", String)
], TagResponseDto.prototype, "created_at", void 0);
_ts_decorate([
    (0, _classtransformer.Expose)(),
    (0, _classtransformer.Transform)(({ value })=>(0, _formatDate.formatDateDDMMYYYY)(value)),
    _ts_metadata("design:type", String)
], TagResponseDto.prototype, "updated_at", void 0);
TagResponseDto = _ts_decorate([
    (0, _classtransformer.Exclude)()
], TagResponseDto);

//# sourceMappingURL=tagResponse.dto.js.map